...
def BondsPreset(strucType):
    ...
    if strucType == 'Si111':
        ...
        bonds = np.array([
            ...
            # [-0.65859,  0.38023 ,  0.64937],[0.65859, 0.38023 , 0.64937],[ 0  , -0.76047,  0.64937]
            #Materials Studio
            [0.378149576,-0.654701306,0.654499008],[0.378151191,0.652938726,0.656256663],[-0.75622161,-0.001163009,0.654314278],
            [0.377213784,-0.654900402,-0.654839851],[0.377617153,0.65523044,-0.654276697],[-0.754152257,-0.000626812,-0.65669921]
        ...
        bonds_adsorption = np.array([
            ...
            # [-0.3467805645, 0.2002101065,0],[0.3467805645, 0.2002101065,0],[0.0, -0.4004254785,0]
            [0.491664547,-0.814314334,0.308477141],[0.581151822,0.759778834,0.291545512],
...
if __name__ == '__main__':
    ...
    StructProp = BondsPreset('WS2+H2O')
    StructProp['phi0'] = 0
